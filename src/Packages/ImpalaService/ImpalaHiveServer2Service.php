...
interface ImpalaHiveServer2ServiceIf extends \TCLIServiceIf {
  /**
   * @param \TGetExecSummaryReq $req
   * @return \TGetExecSummaryResp
   */
  public function GetExecSummary(\TGetExecSummaryReq $req);
  /**
   * @param \TGetRuntimeProfileReq $req
   * @return \TGetRuntimeProfileResp
   */
  public function GetRuntimeProfile(\TGetRuntimeProfileReq $req);
}

class ImpalaHiveServer2ServiceClient extends \TCLIServiceClient implements \ImpalaHiveServer2ServiceIf {
  ...
  public function send_GetExecSummary(\TGetExecSummaryReq $req)
  {
    $args = new \ImpalaHiveServer2Service_GetExecSummary_args();
    $args->req = $req;
  ...
  public function recv_GetExecSummary()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\ImpalaHiveServer2Service_GetExecSummary_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \ImpalaHiveServer2Service_GetExecSummary_result();
  ...
  public function send_GetRuntimeProfile(\TGetRuntimeProfileReq $req)
  {
    $args = new \ImpalaHiveServer2Service_GetRuntimeProfile_args();
    $args->req = $req;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\ImpalaHiveServer2Service_GetRuntimeProfile_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \ImpalaHiveServer2Service_GetRuntimeProfile_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->req = new \TGetExecSummaryReq();
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::STRUCT) {
            $this->success = new \TGetExecSummaryResp();
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->req = new \TGetRuntimeProfileReq();
            $xfer += $this->req->read($input);
          } else {
            $xfer += $input->skip($ftype);
          }
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::STRUCT) {
            $this->success = new \TGetRuntimeProfileResp();
            $xfer += $this->success->read($input);
          } else {
            $xfer += $input->skip($ftype);
          }
